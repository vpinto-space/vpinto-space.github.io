...
BLOG_AUTHOR = "Victor Pinto"  # (translatable)
BLOG_TITLE = "Victor Pinto"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://victorapinto.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://victorapinto.com/"
BLOG_EMAIL = "victor.pinto@gmail.com"
BLOG_DESCRIPTION = {"en": "Victor Pinto's Personal Website",
                    "es": "Pagina Personal de Victor Pinto"}  # (translatable)
...
# Must be a HEX value. # Maybe try #2FBDB5
#THEME_COLOR = '#5670d4'
...
#PROJECTS = (
#    ("projects/*.rst", "projects", "post.tmpl"),
#    ("projects/*.md", "projects", "post.tmpl"),
#    ("projects/*.txt", "projects", "post.tmpl"),
#    ("projects/*.html", "projects", "post.tmpl"),
#)
